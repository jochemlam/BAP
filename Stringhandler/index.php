...
<html lang="nl">
	 ...
	 <body>
       ...
       $input3 = $input1 . $input2;
			 $FirstCaps = ucwords($input1);
			 $AllesCaps = strtoupper($input1);
		...
		<div class="wrapper">
          ...
          if (strpos($input3, '@') <= strpos($input3, '.') && strpos($input3, '@') !==false && strpos($input3, '.') !==false) {
						echo 'true';
          }
          else {
            echo 'false';
          ...
          ?>
					<li>De eerste letter in capital: <?php echo $FirstCaps; ?></li>
					<li>Alles in caps: <?php echo $AllesCaps; ?> </li>
				</ul>
				<hr>
				<ol>
